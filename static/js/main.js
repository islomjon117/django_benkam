...
$(function () {
    ...
    ***************************/
    ...
    const swup = new Swup({
  containers: ["#swup"], // DOMda #swup elementi yo‘q bo‘lishi mumkin
});
...
window.addEventListener("load", () => {
  setTimeout(() => {
    const skeletons = document.querySelectorAll('.team-skeleton');
...
const videoSrc = "https://www.youtube.com/embed/GaxkY5Nwud0";
